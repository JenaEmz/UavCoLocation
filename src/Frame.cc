...
Frame::Frame(const cv::Mat &imLeft,
             ...
             ORBextractor *extractorRight, cv::Mat &K, cv::Mat &dist, ORBVocabulary *voc, float baseline, int craft_id) : mpORBextractorLeft(extractorLeft), mpORBextractorRight(extractorRight),
